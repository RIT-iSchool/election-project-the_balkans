...
insert_user() {
    psql -h localhost -U "$PG_USER" -d "$PG_DATABASE" -c "INSERT INTO \"user\" (id, email, password, first_name, last_name, admin) VALUES ($1, '$2@gmail.com', '123456789', '$3', '$4', false)";
}
...
insert_society_member() {
    psql -h localhost -U "$PG_USER" -d "$PG_DATABASE" -c "INSERT INTO \"societyMember\" (id, user_id, society_id, "role") VALUES ($COUNT, $1, $2, 'member')";
    (($COUNT++))
}
